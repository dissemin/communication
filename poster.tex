...
\block{Data sources}{
    ...
    \begin{itemize}[leftmargin=0pt]
       ...
       \item Metadata from open repositories, through
           the \textbf{preprint search engines} BASE (Bielefeld Academic
        ...
        \item \textbf{Publishers' policies}, through the SHERPA/RoMEO API.
...
\block{Similarity clustering}{
    ...
    {\small Spanning tree created by the similarity classifier}
    \vspace{0.3cm}
